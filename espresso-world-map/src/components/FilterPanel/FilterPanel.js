const FilterPanel = ({ onFilterClick, activeFilter }) => {
  return (
    <div className="absolute bottom-32 left-1/2 transform -translate-x-1/2 sm:left-6 sm:top-1/2 sm:-translate-y-1/2 sm:translate-x-0 z-40 flex flex-row sm:flex-col space-x-4 sm:space-x-0 sm:space-y-4">
